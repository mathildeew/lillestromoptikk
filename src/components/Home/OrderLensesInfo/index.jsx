    ...
    <div className="home-container text-white bg-kleinBlue">
      <div className="max-w-3xl flex flex-col gap-8 px-8">
        ...
        <p>
          ...
          huske. Vi husker alltid ditt siste kjøp, slik at du enkelt kan gjenta
          det neste gang du trenger linser.
        </p>
        <p>
          Ta kontakt med oss for å opprette profil om det er første gang du
          kjøper linser gjennom vår nettbutikk.
        </p>
      </div>
    </div>
  );
