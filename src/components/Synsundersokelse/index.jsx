  ...
  return (
    <>
      <section className="mx-3.5 mb-24 z-10" id="synsundersokelse">
        ...
        <p className="mb-6">
          Våre synsundersøkelser inkluderer alltid utmåling av brillestyrker og
          en grundig øyehelseundersøkels. Vi kartlegger ditt behov og hjelper
          deg med å velge riktig løsning. Ved behov utfører vi supplerende
          tester.
        </p>
        <p>
